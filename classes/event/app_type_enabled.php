 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class app_type_enabled extends base {
    ...
    public static function get_name() {
        return get_string('event:apptypeenabled', 'applaunch');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has enabled a app_type with id '$this->objectid'.";
    }
