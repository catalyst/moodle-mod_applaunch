...
/**
 * Event for when a app_type is created.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class app_type_created extends base {
    ...
    protected function init() {
        $this->data['objecttable'] = 'mod_applaunch_app_types';
        $this->data['crud'] = 'c';
    ...
    public static function get_name() {
        return get_string('event:apptypecreated', 'mod_applaunch');
    }
    ...
    public function get_url() {
        ...
        return new \moodle_url('/mod/applaunch/app_type.php', $params);
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created a app_type with id '$this->objectid'.";
    }
