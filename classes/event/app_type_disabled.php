...
/**
 * Event for when a app_type is disabled.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class app_type_disabled extends base {
    ...
    public static function get_name() {
        return get_string('event:apptypedisabled', 'applaunch');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has disabled a app_type with id '$this->objectid'.";
    }
