...
/**
 * Event for when a app_type is updated.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class app_type_updated extends base {
    ...
    public static function get_name() {
        return get_string('event:apptypeupdated', 'applaunch');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has updated a app_type with id '$this->objectid'.";
    }
