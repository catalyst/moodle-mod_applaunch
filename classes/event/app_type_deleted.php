 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class app_type_deleted extends base {
     ...
     *
     * @param string $id The id of the app_type
    ...
    public static function get_name() {
        return get_string('event:apptypedeleted', 'applaunch');
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/applaunch/app_type.php');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has deleted a app_type with id '$this->objectid'.";
    }
